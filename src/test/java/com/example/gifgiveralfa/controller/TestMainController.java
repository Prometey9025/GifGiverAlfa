...
import com.example.gifgiveralfa.service.ExchangeRatesServiceImpl;
import com.example.gifgiveralfa.service.GifServiceImpl;
...
public class TestMainController {
    ...
    public void whenReturnListOfCharCodes() throws Exception {
        ...
        mockMvc.perform(get("/gifgiver/getcodes")
    ...
    public void whenReturnRichGif() throws Exception {
        ...
        mockMvc.perform(get("/gifgiver/getgif/TESTCODE")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
